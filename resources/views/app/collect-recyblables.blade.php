        ...
        <form action="#" class="buysell-form">
            <div class="buysell-field form-group">
                ...
                <div class="form-control-group">
                    ...
                    <input type="text" class="form-control form-control-lg form-control-number" id="buysell-amount" name="phone" placeholder="08062238849">
            ...
            <div class="buysell-field form-group">
                ...
                <div class="form-control-group">
                    <input type="text" class="form-control form-control-lg form-control-number" id="buysell-amount" name="quantity" placeholder="0.000123">
                    <div class="form-dropdown">
                        <div class="text">KG<span>/</span></div>
                        <div class="dropdown">
                            <a href="#" class="dropdown-indicator-caret" data-bs-toggle="dropdown" data-offset="0,2">KG</a>
            ...
            <div class="buysell-field form-action">
                <a class="btn btn-lg btn-block btn-primary" data-bs-toggle="modal" href="#buy-coin">Collect Recyclables</a>
            </div><!-- .buysell-field -->
            <div class="form-note text-base text-center">NB: You'll be charged for this collection, <a href="#">Learn about recyclables collection</a>.</div>
        </form><!-- .buysell-form -->
    </div><!-- .buysell-block -->
</div><!-- .buysell -->
